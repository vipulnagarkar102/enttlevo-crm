                            ...
                            <div className="flex gap-8">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 pb-2 text-[0.9rem] font-medium transition-all relative ${viewTab === tab.id ? 'text-[#FF8000]' : 'text-on-surface-variant hover:text-on-surface'
                                            }`}
                                    >
