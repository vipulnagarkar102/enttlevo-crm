              ...
              currentData.map((member) => (
                ...
                >
                  <td className="px-6 py-0">
                    <span className="text-[0.85rem] font-semibold text-on-surface">{member.firstName}</span>
                  </td>
                  <td className="px-6 py-0 border-l border-outline/5">
                    <span className="text-[0.85rem] font-medium text-on-surface-variant">{member.lastName}</span>
                  </td>
                  <td className="px-6 py-0 border-l border-outline/5">
                    <span className="text-[0.8rem] text-on-surface font-semibold">{member.username}</span>
                  </td>
                  <td className="px-6 py-0 border-l border-outline/5">
                    <span className="text-[0.8rem] text-[#006495] hover:underline font-medium">{member.email}</span>
                  </td>
                  {/* Fixed (Sticky Right) View Member Profile button popup */}
